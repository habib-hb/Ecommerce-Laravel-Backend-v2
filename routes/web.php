...
Route::post('api/dashboard/review-upload', function(Request $request){
        ...
        // Review Image Full Url
        $review_image_full_url = asset($review_image_url);
        ...
        if(count($availability_checking) == 0){
            $review_image_url ? DB::table('product_customers')->insert([
                    ...
                    'customer_avatar' => $review_image_full_url,
...
// Retriving all the orders data for the admin dashboard
Route::get('api/dashboard/all_orders_data_for_order_placement_by_users' , function(){
